...
CREATE INDEX IF NOT EXISTS idx_media_relationships_from ON media_relationships("from", type, "order");
CREATE INDEX IF NOT EXISTS idx_media_relationships_to ON media_relationships("to", type, "order");
...
CREATE INDEX IF NOT EXISTS idx_credits_media ON credits(media_id, type, "order");
CREATE INDEX IF NOT EXISTS idx_credits_person ON credits(person_id, type);
CREATE INDEX IF NOT EXISTS idx_credits_director ON credits(media_id) WHERE computed_is_director = 1;
CREATE INDEX IF NOT EXISTS idx_credits_cast ON credits(media_id) WHERE computed_is_cast = 1;
...
CREATE INDEX IF NOT EXISTS idx_videos_media ON videos(media_id, type, "order");
