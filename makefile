...
preview:
	docker build --no-cache -t moviefinder-app-go . && docker run --rm -it -p 8080:8080 --env-file .env -e DATABASE_URL=postgres://postgres:postgres@host.docker.internal:5433/postgres?sslmode=disable moviefinder-app-go
